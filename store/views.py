...
def store(request):
    ...
    if data is None:
        data = {'cartItems': 0, 'order': None, 'items': []}
...
def processOrder(request):
    ...
    try:
        ...
        # Handle the case where the customer or order does not exist
        return JsonResponse('Customer or order does not exist', safe=False)
